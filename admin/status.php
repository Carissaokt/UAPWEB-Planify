...
<aside class="w-64 bg-blue-600 text-white flex flex-col justify-between py-8 px-6 shadow-lg">
  <div>
    ...
    <nav class="space-y-4">
      ...
      <a href="status.php" class="flex items-center gap-3 py-2 px-3 rounded hover:bg-blue-500 bg-blue-700 transition <?= basename($_SERVER['PHP_SELF']) === 'status.php' ? 'bg-blue-700' : '' ?> transition">
